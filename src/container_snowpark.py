...
container_snowpark = Blueprint('container_snowpark', __name__)

## Top 10 customers in date range
dateformat = '%Y-%m-%d'

@container_snowpark.route('/customers/top10')
def customers_top10():
    # Validate arguments
...
@container_snowpark.route('/clerk/<clerkid>/yearly_sales/<year>')
